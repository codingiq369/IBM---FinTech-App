...
Provisions the uat cluster, database, secrets, IAM roles, DNS/cert/WAF, and
CloudWatch resources this environment needs, by calling the shared modules in
`infrastructure/terraform/modules/`.

    cd infrastructure/terraform/environments/uat
    terraform init
...
Outputs feed `infrastructure/kubernetes/overlays/uat` (DB host, IAM role
